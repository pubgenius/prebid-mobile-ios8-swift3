Pod::Spec.new do |s|
  ...
  s.name         = "PrebidMobile-pubg-ios8-swift3"
  s.version      = "1.2.01"
  s.summary      = "PrebidMobile is a lightweight framework that integrates directly with Prebid Server. This has been modified by pubGENIUS to support iOS 8 and Swift 4.2"
  ...
  s.platform     = :ios, "8.0"
  s.swift_version = '3.0'
  s.source       = { :git => "https://github.com/pubgenius/prebid-mobile-ios8-swift3.git", :tag => "#{s.version}" }
  s.xcconfig = {
